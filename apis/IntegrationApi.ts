...
export class IntegrationApi {
  ...
  private createApiClient(frontasticContext: Context) {
    const instance = axios.create({
      baseURL: `${frontasticContext.project.configuration.talonOne.host}/v2`,
      headers: {
        Authorization: `ApiKey-v1 ${frontasticContext.project.configuration.talonOne.apiKey[this.currency]}`,
